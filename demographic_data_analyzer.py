...
def calculate_demographic_data(print_data=True):
    ...
    #substract from education column higher_education
    ...
    highest_earning_country=num_min_workers['native-country'].value_counts().idxmax()

    highest_earning_country_percentage = num_min_workers.loc[num_min_workers['salary']=='>50K'].shape[0] / num_min_workers.shape[0] * 100

    # Identify the most popular occupation for those who earn >50K in India.
    top_in_temp = df.loc[df['native-country']=='India']
    top_IN_occupation = top_in_temp.loc[top_in_temp['salary']=='>50K', 'occupation'].value_counts().idxmax()
