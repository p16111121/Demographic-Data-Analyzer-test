...
def calculate_demographic_data(print_data=True):
    ...
    rich_country_percentage = (rich_country_counts / total_country_counts * 100).sort_values(ascending=False)
    ...
    india_rich_occupations = df[(df['native-country'] == 'India') & (df['salary'] == '>50K')]['occupation'].value_counts()
