...
def calculate_demographic_data(print_data=True):
    ...
    ##rich_count = (num_min_workers['salary'] == '>50K').sum()
    ##total_count = len(num_min_workers)
    ##rich_percentage = (rich_count / total_count) * 100
    ...
    highest_earning_country = (rich_country_counts / all_country_counts).idxmax()
